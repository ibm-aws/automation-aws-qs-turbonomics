...
## 250 - Turbonomic on OpenShift for Multi Cloud

GitOps deployment of Turbonomic on Multi Cloud environments AWS, Azure and IBM Cloud
...
![Reference Diagram](./250-turbonomic-multicloud.png)
...
- [docs/gitops-ocp-turbonomic.md](docs/gitops-ocp-turbonomic.md)
